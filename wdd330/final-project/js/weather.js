...
function doWeather(zip) {
  ...
  let weatherArticle = document.querySelector('.modal-content');
  function showCurrWeather(currWeatherData) {
    //let weatherArticle = document.querySelector('.modal-content');
    let currWeatherDiv = document.createElement('div');
    weatherArticle.appendChild(currweatherDiv);
    currWeatherDiv.setAttribute('id', 'current-container');
    ...
    currWeatherDiv.appendChild(weatherIcon);
    currWeatherDiv.appendChild(weatherCurr);
    currWeatherDiv.appendChild(weatherTemp);
    currWeatherDiv.appendChild(weatherHumidity);
    currWeatherDiv.appendChild(weatherWind);
  }
  ...
  function showForecast(forecastData) {
    ...
    //let fcstDiv = document.querySelector('.modal-content');
    let fcstDiv = document.createElement('div');
    fcstDiv.setAttribute('id', 'forecast-div');
    ...
    weatherArticle.appendChild(fcstDiv);
